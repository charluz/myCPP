...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
SRCFILES= main.c prog_dbg.c prog_util.c prog_arg.c myut_string.c
OBJFILES=main.o prog_dbg.o prog_util.o prog_arg.o myut_string.o
ALL_OBJFILES=$(OBJFILES)
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= main.o prog_arg.o prog_util.o prog_dbg.o myut_string.o 
NO_LINK=
