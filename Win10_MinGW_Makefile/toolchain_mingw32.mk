...
## MinGW
#-----------------------------------------------------------
MINGW 			= D:\@myProgramFiles\ming-w64
MINGW_BIN 		= $(MINGW)\bin

MINGW_LIB		= $(MINGW)\lib
MINGW_LIB		+= $(MINGW)\lib\gcc\x86_64-w64-mingw32\lib
MINGW_LIB		+= $(MINGW)\lib\gcc\x86_64-w64-mingw32\4.9.1

MINGW_INC		= $(MINGW_LIB)\gcc\x86_64-w64-mingw32\4.9.1\include
MINGW_INC		+= $(MINGW_LIB)\gcc\x86_64-w64-mingw32\4.9.1\include-fixed
...
## OpenCV V3.2
#-----------------------------------------------------------
CV32			= E:\OpenCV32\build_eclipse\install
